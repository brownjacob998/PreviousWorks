...
// PASTLWTR : 1.2
// File generated on 7/29/2019 7:41:23 PM from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll (1)
...
//   Error creating palette bitmap of (TMailClient) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TAttachment) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TCertificate) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (THeaderCollection) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (THeaderItem) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TImap4Folder) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TMail) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TMailAddress) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TMailInfo) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TMailServer) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TMailReport) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TTools) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TUIDLManager) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TUIDLItem) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TGetMailInfosParamType) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TAddressCollection) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TAttachmentCollection) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TMailInfoCollection) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TFolderCollection) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TCategoryCollection) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TCategory) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TSimpleJsonArray) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TSimpleJsonParser) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
//   Error creating palette bitmap of (TOAuthResponseParser) : Server C:\Program Files\EAGetMail\Lib\native\x86\EAGetMailObj.dll contains no icons
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
...
const
  ...
  IID_IOAuthResponseParser: TGUID = '{2CBA3E15-44BB-428C-9DD5-68DC02957C37}';
  CLASS_OAuthResponseParser: TGUID = '{FAF4DE6F-1303-4851-B659-8F8BEB51F1A0}';
type
...
// *********************************************************************//
  IMailClient = interface(IDispatch)
    ...
    function SearchMailList(const Condition: WideString): IMailInfoCollection; safecall;
...
// *********************************************************************//
  IMailClientDisp = dispinterface
    ...
    function SearchMailList(const Condition: WideString): IMailInfoCollection; dispid 56;
  end;
...
// *********************************************************************//
  ITools = interface(IDispatch)
    ...
    procedure RenameFile(const FileName: WideString; const NewName: WideString); safecall;
  end;
...
// *********************************************************************//
  IToolsDisp = dispinterface
    ...
    procedure RenameFile(const FileName: WideString; const NewName: WideString); dispid 13;
  end;
...
// *********************************************************************//
  IUIDLManager = interface(IDispatch)
    ...
    procedure SyncUIDLEX(const oServer: IMailServer; const Infos: IMailInfoCollection); safecall;
    property Count: Integer read Get_Count;
  end;
...
// *********************************************************************//
  IUIDLManagerDisp = dispinterface
    ...
    procedure SyncUIDLEX(const oServer: IMailServer; const Infos: IMailInfoCollection); dispid 13;
  end;
...
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {2CBA3E15-44BB-428C-9DD5-68DC02957C37}
// *********************************************************************//
  IOAuthResponseParser = interface(IDispatch)
    ['{2CBA3E15-44BB-428C-9DD5-68DC02957C37}']
    ...
    property AccessToken: WideString read Get_AccessToken;
    property RefreshToken: WideString read Get_RefreshToken;
    property IdToken: WideString read Get_IdToken;
    property TokenExpiresInSeconds: Integer read Get_TokenExpiresInSeconds;
    property EmailInIdToken: WideString read Get_EmailInIdToken;
  end;
...
// *********************************************************************//
  IOAuthResponseParserDisp = dispinterface
    ...
    property AccessToken: WideString readonly dispid 2;
    property RefreshToken: WideString readonly dispid 3;
    property IdToken: WideString readonly dispid 4;
    property TokenExpiresInSeconds: Integer readonly dispid 5;
    property EmailInIdToken: WideString readonly dispid 6;
  end;
...
{$ENDIF}
  ...
  public
    ...
    function SearchMailList(const Condition: WideString): IMailInfoCollection;
...
{$ENDIF}
  ...
  public
    ...
    procedure RenameFile(const FileName: WideString; const NewName: WideString);
...
{$ENDIF}
  ...
  public
    ...
    procedure SyncUIDLEX(const oServer: IMailServer; const Infos: IMailInfoCollection);
...
function TMailClient.SearchMailList(const Condition: WideString): IMailInfoCollection;
begin
  Result := DefaultInterface.SearchMailList(Condition);
end;
...
procedure TTools.RenameFile(const FileName: WideString; const NewName: WideString);
begin
  DefaultInterface.RenameFile(FileName, NewName);
end;
...
procedure TUIDLManager.SyncUIDLEX(const oServer: IMailServer; const Infos: IMailInfoCollection);
begin
  DefaultInterface.SyncUIDLEX(oServer, Infos);
end;
...
const
  CServerData: TServerData = (
    ClassID:   '{FAF4DE6F-1303-4851-B659-8F8BEB51F1A0}';
    IntfIID:   '{2CBA3E15-44BB-428C-9DD5-68DC02957C37}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
begin
  RegisterComponents(dtlServerPage, [TMailClient, TAttachment, TCertificate, THeaderCollection, 
    ...
    TCategoryCollection, TCategory, TSimpleJsonArray, TSimpleJsonParser, TOAuthResponseParser]);
end;
