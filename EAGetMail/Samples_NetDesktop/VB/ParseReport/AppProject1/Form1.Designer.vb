...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.chkNewOnly.Text = "Retrieve new report only (IMAP, EWS, WebDAV)"
        ...
        Me.label6.Text = "Warning: if ""leave a copy of report on server"" is not checked,  the reports on th" & _
    "e server will be deleted !"
        ...
        Me.chkLeaveCopy.Text = "Leave a copy of report on server"
        '
        'ComboBoxProtocol
        '
        ...
        'textReport
        '
        Me.textReport.Location = New System.Drawing.Point(289, 270)
        Me.textReport.Multiline = True
        Me.textReport.Name = "textReport"
        Me.textReport.ScrollBars = System.Windows.Forms.ScrollBars.Vertical
        Me.textReport.Size = New System.Drawing.Size(556, 228)
        Me.textReport.TabIndex = 4
        '
        'Form1
        '
