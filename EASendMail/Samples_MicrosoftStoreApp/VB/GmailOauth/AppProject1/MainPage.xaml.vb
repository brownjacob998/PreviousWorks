...
#End Region
    ...
    Private Async Function _sendEmailAsync() As Task
        ...
        If String.Compare(replyTo.Address, _oauthWrapper.OauthProvider.UserEmail, StringComparison.OrdinalIgnoreCase) <> 0 Then
...
#Region "Gmail Web Oauth"
    ...
    Private Async Function _doOauthAsync() As Task
        ...
        If _oauthWrapper Is Nothing Then
            Dim provider As OauthProviderInterface =
                GoogleOauthProvider.Create("1072602369179-aru4rj97ateiho9rt4pf5i8l1r01mc16.apps.googleusercontent.com",
        ...
        OauthBrowser.Navigate(New Uri(_oauthWrapper.OauthProvider.GenerateFullAuthUri()))
        ShowOauthPanel(True)
