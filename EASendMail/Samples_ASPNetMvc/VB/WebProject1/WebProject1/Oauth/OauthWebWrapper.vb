...
Public Class OauthWebWrapper
    Public Sub New(ByVal oauthProvider As OauthProviderInterface)
        _provider = oauthProvider
    End Sub

    Private _provider As OauthProviderInterface = Nothing
    Public ReadOnly Property OauthProvider As OauthProviderInterface
        Get
            Return _provider
        End Get
    End Property
    ...
    Public Sub RequestAccessTokenAndUserEmail()
        ...
        Dim requestData As String = _provider.GenerateAccessTokenRequestData(AuthorizationCode)
    ...
    Public Sub RefreshAccessToken()
        ...
        Dim requestData As String = _provider.GenerateRefreshTokenRequestData()
        Dim responseText As String = _postString(_provider.TokenUri, requestData)
        Dim parser As OAuthResponseParser = New OAuthResponseParser()
        parser.Load(responseText)
        _provider.AccessToken = parser.AccessToken
